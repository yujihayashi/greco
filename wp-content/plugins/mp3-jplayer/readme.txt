...
HTML5 audio players for posts, pages, and sidebars. HTML 5 / Flash fallback.
...
2. Search for 'mp3-jplayer' and hit the 'Install now' link in the results, Wordpress will install it.
